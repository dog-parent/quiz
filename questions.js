...
},
{
  ...
  // ---------- PIVOTING QUESTION (decider) ----------
  {
    ...
    options: [
      ...
      {
        text: "Keeps scratching, biting, licking, or losing fur in patches, restless, anxious, startles easily, poor sleep",
        value: "anxiety",
        key: "pivotTopic",
        buttontext: "Continue",
        nestedQuestions: [
