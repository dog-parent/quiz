...
const questions = [
  ...
  // [color=#f0f2f5][size=7px]---[/size][/color][color=#f0f2f5][size=7px]---[/size][/color][color=#f0f2f5][size=7px]---[/size][/color]- INTRODUCTORY QUESTIONS (personalization keys saved) [color=#f0f2f5][size=7px]---[/size][/color][color=#f0f2f5][size=7px]---[/size][/color][color=#f0f2f5][size=7px]---[/size][/color]-
  {
    id: "q_pet_name",
    type: "input",
...
},
{
  ...
  description: "This helps reveal how much control or chaos surrounds {answers.petName} daily life, and how that environment silently shapes every bad habit you could be ignoring.",
  options: [
    {
  ...
  // [color=#f0f2f5][size=7px]---[/size][/color][color=#f0f2f5][size=7px]---[/size][/color][color=#f0f2f5][size=7px]---[/size][/color]- PIVOTING QUESTION (decider) [color=#f0f2f5][size=7px]---[/size][/color][color=#f0f2f5][size=7px]---[/size][/color][color=#f0f2f5][size=7px]---[/size][/color]-
  {
    id: "q_main_concern",
    type: "choice",
    ...
    // Your answer here reveals what part of {answers.petName}’s life might already be slipping, and how deep this issue could quietly be running beneath the surface. 
    description: "Ignoring the real problem is how most dog parents slowly fail their pets without realizing it. You can pick an option even if it has only one of the listed problems that applies to {answers.petName}.",
    options: [
      {
